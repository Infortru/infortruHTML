...
<body>
    ...
    <h1 class="text-center mt-5">Administrar Bricolage</h1>

<?php

    require_once '../../conexion.php';

    $sql = "SELECT * FROM bricolage";
    ...
    if ($resultado) {
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<td>
                    <a href='../editar/editarBricolage.php?id=" . $fila['id'] . "' class='btn btn-warning'>Editar</a>
                    <a href='../eliminar/eliminarBricolage.php?id=" . $fila['id'] . "' class='btn btn-danger'>Eliminar</a>
                  </td>";
            echo "</tr>";
        }

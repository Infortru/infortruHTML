...
<body>
    ...
    <h1 class="text-center mt-5">Administrar Jardinería</h1>
<?php

    require_once '../../conexion.php';

    $sql = "SELECT * FROM jardineria";
    ...
    if ($resultado) {
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<td>
                    <a href='../editar/editarJardineria.php?id=" . $fila['id'] . "' class='btn btn-warning'>Editar</a>
                    <a href='../eliminar/eliminarJardineria.php?id=" . $fila['id'] . "' class='btn btn-danger'>Eliminar</a>
                  </td>";
            echo "</tr>";
        }

...
<body>
    ...
    <h1 class="text-center mt-5">Administrar Trucos</h1>

<?php

    require_once '../../conexion.php';

    $sql = "SELECT * FROM trucos";
    ...
    if ($resultado) {
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<td>
                    <a href='../editar/editarTrucos.php?id=" . $fila['id'] . "' class='btn btn-warning'>Editar</a>
                    <a href='../eliminar/eliminarTrucos.php?id=" . $fila['id'] . "' class='btn btn-danger'>Eliminar</a>
                  </td>";
            echo "</tr>";
        }

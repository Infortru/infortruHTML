...
<body>
    ...
    <h1 class="text-center mt-5">Administrar Recetas</h1>
...
<?php
    ...
    if ($resultado) {
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<td>
                    <a href='../editar/editarRecetas.php?id=" . $fila['id'] . "' class='btn btn-warning'>Editar</a>
                    <a href='../eliminar/eliminarRecetas.php?id=" . $fila['id'] . "' class='btn btn-danger'>Eliminar</a>
                  </td>";
            echo "</tr>";
        }

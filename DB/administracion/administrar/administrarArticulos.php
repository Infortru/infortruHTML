...
<body>
    ...
    <h1 class="text-center mt-5">Administrar Artículos</h1>
<?php
   ...
   $sql = "SELECT * FROM articulos";
    ...
    if ($resultado) {
        ...
        while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<td>
                    <a href='../editar/editarArticulos.php?id=" . $fila['id'] . "' class='btn btn-warning'>Editar</a>
                    <a href='../eliminar/eliminarArticulos.php?id=" . $fila['id'] . "' class='btn btn-danger'>Eliminar</a>
                  </td>";
            echo "</tr>";
        }

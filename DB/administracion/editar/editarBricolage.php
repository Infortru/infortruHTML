...
<body>
    <div class="container">
        <h1 class="text-center mt-5">Editar Bricolage</h1>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="../administrar/administrarBricolage.php">Administrar Bricolage</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "SELECT * FROM bricolage WHERE id = ?";
        ...
        if ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<form action='../actualizar/actualizarBricolage.php' method='post' enctype='multipart/form-data' style='max-width: 600px; margin: auto;' class='mt-5'>";

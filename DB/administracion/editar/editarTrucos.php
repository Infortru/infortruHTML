...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "SELECT * FROM trucos WHERE id = ?";
        ...
        if ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<form action='../actualizar/actualizarTrucos.php' method='post' enctype='multipart/form-data' style='max-width: 600px; margin: auto;' class='mt-5'>";

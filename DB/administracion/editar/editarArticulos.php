...
<body>
    <div class="container">
        <h1 class="text-center mt-5">Editar Artículos</h1>
...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<form action='../actualizar/actualizarArticulos.php' method='post' enctype='multipart/form-data' style='max-width: 600px; margin: auto;' class='mt-5'>";
